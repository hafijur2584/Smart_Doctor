    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.doctor.update',$doctor->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="box-body">
                            <div class="col-xs-4">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $doctor->title }}" name="title" id="name">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" class="form-control" value="{{ $doctor->email }}" name="email" id="email">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="specialist">Specialist</label>
                                    <input type="text" class="form-control" value="{{ $doctor->specialist }}" name="specialist" id="specialist">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="qualification">Qualification</label>
                                    <input type="text" class="form-control" value="{{ $doctor->qualification }}" name="qualification" id="qualification">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="fb">Facebook</label>
                                    <input type="text" class="form-control" value="{{ $doctor->fb }}" name="fb" id="fb">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="tw">Tweeter</label>
                                    <input type="text" class="form-control" value="{{ $doctor->tw }}" name="tw" id="tw">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="ins">Instagram</label>
                                    <input type="text" class="form-control" value="{{ $doctor->ins }}" name="ins" id="ins">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label for="phone">Phone Number</label>
                                    <input type="text" class="form-control" value="{{ $doctor->phone }}" name="phone" id="phone">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <select name="hospital_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                        ...
                                        @foreach($hospitals as $hospital)
                                            <option @if($doctor->hospital_id==$hospital->id) selected @endif value="{{ $hospital->id }}" >{{ $hospital->name }}</option>
                                        @endforeach
                                    </select>
